...
DP.Shared = {
   ...
   ["standingsexf"] = {"misscarsteal2pimpsex", "shagloop_hooker", "Standing Sex F", "standingsexm", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteLoop = true,
   }},
   ["standingsexm"] = {"misscarsteal2pimpsex", "shagloop_pimp", "Standing Sex M", "standingsexf", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteLoop = true,
   }},
...
DP.Emotes = {
   ...
   ["standingsexf"] = {"misscarsteal2pimpsex", "shagloop_hooker", "Standing Sex F", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["standingsexm"] = {"misscarsteal2pimpsex", "shagloop_pimp", "Standing Sex M", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
